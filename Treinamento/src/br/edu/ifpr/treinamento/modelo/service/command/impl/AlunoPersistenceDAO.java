...
public class AlunoPersistenceDAO implements JpaPersistenceDAO<String, Aluno> {
	...
	private Aluno get(String namedQuery, String atributo, Object valorBusca) {
		TypedQuery<Aluno> query = em.createNamedQuery (namedQuery, Aluno.class);
		Aluno dado = null;
	...
	public int delete(String key) {
      ...
      Aluno dado = get("Aluno.findByCpf","cpf",CpfFormatter.formatCpf(key));
      if (dado != null) {
         em.getTransaction().begin();
         em.remove(dado);
         em.getTransaction().commit();
